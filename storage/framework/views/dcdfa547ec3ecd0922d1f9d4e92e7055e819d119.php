...
<?php $__env->startSection('pageSubTitle'); ?>
    <?php echo e(trans('admin_content.edit_user')); ?>
            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo e(trans('admin_content.edit_user')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><?php echo e(trans('admin_content.edit_user')); ?></h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <?php echo $__env->make('alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <form class="form form-horizontal needs-validation" method="post" enctype="multipart/form-data" action="<?php echo e(route('users.update', auth()->id())); ?>">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="<?php echo e(trans('admin_content.name')); ?>" name="name" value="<?php echo e(auth()->user()->name); ?>" required>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="email" class="form-control" placeholder="<?php echo e(trans('admin_content.email')); ?>" name="email" value="<?php echo e(auth()->user()->email); ?>" required>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="tel" class="form-control" placeholder="<?php echo e(trans('admin_content.password')); ?>" minlength="6" name="password">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="tel" class="form-control" placeholder="<?php echo e(trans('admin_content.password_confirmation')); ?>" name="password_confirmation">
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\frucci\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>