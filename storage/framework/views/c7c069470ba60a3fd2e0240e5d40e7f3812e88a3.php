...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/app-assets/css/pages/dashboard-analytics.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/app-assets/css/pages/card-analytics.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/app-assets/css/plugins/tour/tour.css')); ?>">
    <!-- END: Page CSS-->
...
</html><?php /**PATH F:\arrr\projects\New folder\frucci\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>