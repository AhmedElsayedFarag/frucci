...
<?php $__currentLoopData = $question->getTranslationsArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale =>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-12">
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                    <span><?php echo e(trans("admin_content.question_in_$locale")); ?></span>
                                                </div>
                                                <div class="col-md-10">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control" placeholder="<?php echo e(trans('admin_content.question')); ?>" name="<?php echo e("answer_$locale"); ?>" required><?php echo e($value['answer']); ?></textarea>
                                                    <div class="invalid-feedback">
                                                        <?php echo e(trans('admin_content.please_enter_question')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\arrr\projects\New folder\frucci\resources\views/admin/questions/edit.blade.php ENDPATH**/ ?>