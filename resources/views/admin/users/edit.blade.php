        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        @include('alert')
                        <form class="form form-horizontal needs-validation" method="post" enctype="multipart/form-data" action="{{route('users.update', auth()->id())}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="tel" class="form-control" placeholder="{{trans('admin_content.phone')}}" name="phone" value="{{auth()->user()->phone}}" minlength="10" maxlength="14" required>
                                                <div class="invalid-feedback">
